...
abstract class MainActivityBase : AppCompatActivity(), ViewSearchContract {
    ...
    private fun setUI() {
        ...
        setQueryListener()
        setRecyclerView()
        searchButton.setOnClickListener { viewModel.searchGitHub(searchEditText.text.toString()) }
    }
    ...
    abstract fun createRepository(): RepositoryContract
